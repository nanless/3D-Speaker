...
# -*- coding: utf-8 -*-
"""
Simple script to run diarization (VAD + Embedding + Clustering) on all audio files in a directory.
This script does NOT use segmentation model (no overlap detection).

Usage:
    python run_diarization_simple.py [--src_dir DIR] [--out_dir DIR] [--nprocs N] [--speaker_num N]
"""
...
DEFAULT_SRC_DIR = "/root/code/own/download_next_online_audio_for_speakerdetection_1125/original_audios"
...
def main():
    parser = argparse.ArgumentParser(
        description="Run diarization (VAD + Embedding + Clustering) on all audio files in a directory. "
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Output directory for results (default: <src_dir_parent>/diarization_results)"
    )
    parser.add_argument(
        "--nprocs",
        type=int,
