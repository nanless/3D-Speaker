...
def load_spk2utt(spk2utt_path):
    ...
    with open(spk2utt_path, 'r') as f:
        for line in f:
            ...
            elif any(spk.startswith(prefix) for prefix in ['KASR_', 'CEEC_', 'SPEE_']):
...
def main():
    ...
    parser.add_argument('--num-trials', type=int, default=20000, help='Total number of trials to generate (default: 20000)')
